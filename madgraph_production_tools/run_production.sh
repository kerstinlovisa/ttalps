...
# user_base_path="/afs/desy.de/user/l/lrygaard/ALPpheno/ttalps/madgraph_production_tools/"
# output_path="/nfs/dust/cms/user/lrygaard/ttalps"
# python_path="/afs/desy.de/user/l/lrygaard/tools/miniconda3/envs/tta/bin/python3"

# export PYTHIA8DATA=/afs/desy.de/user/l/lrygaard/tools/MG5_aMC_v3_4_2/HEPTools/pythia8/share/Pythia8/xmldoc
